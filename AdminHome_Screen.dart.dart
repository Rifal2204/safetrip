...
import 'package:safetrip/screens/adminhomescreen/addstudent_screen.dart';
...
class AdminHomeScreen extends StatelessWidget {
  ...
  const AdminHomeScreen({super.key, required this.gender, required this.fullName});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            _buildOptionButton(context, Icons.add, " اضافة بيانات طالب", () {
              // ميثود تحضير الطلاب
            }),
            const SizedBox(height: 20),
            _buildOptionButton(context, Icons.edit, "تعديل بيانات طالب ", () {
